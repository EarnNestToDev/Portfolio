...
export default function Carousel(
    ...
    return (
        <div className="relative w-full h-full overflow-hidden p-2 grid grid-cols-1 grid-rows-[100fr_1fr]">
                ...
                {content.map((_, i) => (
                    <div
                        className={`
                            ...
                            transition-all
                            duration-300
                            ${activeIndicator === i ? "bg-zinc-900 dark:bg-zinc-50 opacity-100 scale-150" : "bg-zinc-900 dark:bg-zinc-50 opacity-20"}
                        `}
                    />
                ))}
            </div>
