...
"[project]/node_modules/react-lite-youtube-embed/dist/index.es.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/**
* @ibrahimcesar/react-lite-youtube-embed v3.3.2
...
const z = {
    ...
    const [a, r] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
...
function ee(e, t) {
    const [u, s] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"](!1), [a, r] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"](e.alwaysLoadIframe || !1), o = encodeURIComponent(e.id), h = typeof e.playlistCoverId == "string" ? encodeURIComponent(e.playlistCoverId) : null, c = e.title, d = e.poster || "hqdefault", L = e.announce || "Watch", U = e.alwaysLoadIframe ? e.autoplay && e.muted : !0, C = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ee.useMemo[C]": ()=>{
            ...
            return e.params && new URLSearchParams(e.params.startsWith("&") ? e.params.slice(1) : e.params).forEach({
                "ee.useMemo[C]": (w, k)=>{
                    I.append(k, w);
                }
            }["ee.useMemo[C]"]), I;
        ...
        "ee.useMemo[b]": ()=>e.cookie ? "https://www.youtube.com" : "https://www.youtube-nocookie.com"
    }["ee.useMemo[b]"], [
        e.cookie
        ...
        "ee.useMemo[M]": ()=>e.playlist ? `${b}/embed/videoseries?${C.toString()}` : `${b}/embed/${o}?${C.toString()}`
    }["ee.useMemo[M]"], [
        e.playlist,
        b,
        o,
        C
    ]), _ = !e.thumbnail && !e.playlist && d === "maxresdefault", D = e.webp ? "webp" : "jpg", v = e.webp ? "vi_webp" : "vi", A = _ ? K(e.id, v, D, d) : null, g = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ee.useMemo[g]": ()=>e.thumbnail || A || `https://i.ytimg.com/${v}/${e.playlist ? h : o}/${d}.${D}`
    }["ee.useMemo[g]"], [
        e.thumbnail,
        A,
        v,
        ...
        d,
        D
    ]), P = e.activatedClass || "lyt-activated", W = e.adNetwork || !1, B = e.aspectHeight || 9, j = e.aspectWidth || 16, x = e.iframeClass || "", F = e.playerClass || "lty-playbtn", Q = e.wrapperClass || "yt-lite", S = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"](e.onIframeAdded || ({
        "ee.useCallback[S]": function() {}
    })["ee.useCallback[S]"], [
        e.onIframeAdded
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"]({
        ...
        "ee.useEffect": ()=>{
            if (!a || !e.enableJsApi || !(e.onReady || e.onStateChange || e.onError || e.onPlay || e.onPause || e.onEnd || e.onBuffering || e.onPlaybackRateChange || e.onPlaybackQualityChange)) return;
            let R = !1, w = !1;
            const k = {
                "ee.useEffect.k": (m)=>{
                    if (m.origin !== "https://www.youtube.com" && m.origin !== "https://www.youtube-nocookie.com") return;
                    let n;
                    try {
                            ...
                            if (n.info?.playerState !== void 0) {
                                ...
                                switch(e.onStateChange && e.onStateChange({
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    case 0:
                                        e.onEnd?.(), e.stopOnEnd && typeof t == "object" && t?.current?.contentWindow && t.current.contentWindow.postMessage('{"event":"command","func":"stopVideo","args":""}', "*");
                                        break;
                                    case 3:
                                        e.onBuffering?.();
                                        break;
            ...
            const N = [], T = {
                "ee.useEffect.T": ()=>{
                    typeof t == "object" && t?.current?.contentWindow && t.current.contentWindow.postMessage('{"event":"listening","id":"' + o + '"}', "*");
                }
            }["ee.useEffect.T"], $ = {
                "ee.useEffect.$": ()=>{
                    if (w) return;
            ...
            return typeof t == "object" && t?.current ? (t.current.addEventListener("load", $), t.current.contentDocument?.readyState === "complete" && $()) : [
                200,
                500,
                1e3,
                2e3,
        ...
        children: [
            !e.lazyLoad && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("link", {
                rel: V,
                href: g,
                as: "image"
            }),
            /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: u && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        ...
                        W && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("link", {
                                    rel: "preconnect",
            ...
            e.seo && !e.playlist && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("script", {
                type: "application/ld+json",
                dangerouslySetInnerHTML: {
                    __html: p(e.id, c, g, b, e.seo)
                }
            }),
            H && !e.playlist && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("noscript", {
                children: /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxs"])("a", {
            ...
            /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxs"])(Y, {
                onPointerOver: J,
                onClick: O,
                className: `${Q} ${a ? P : ""}`,
                "data-title": c,
                ...
                children: [
                    e.lazyLoad && !a && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("img", {
                        src: g,
                        alt: `${c} - YouTube thumbnail`,
                        className: "lty-thumbnail",
                        loading: "lazy"
                    }),
                    e.playlist && !a && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
                        className: "lty-playlist-icon",
                        "aria-hidden": "true"
                    }),
                    /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("button", {
                        type: "button",
                        className: F,
                        "aria-label": `${L} ${c}`,
                        ...
                        children: /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("span", {
                            className: "lty-visually-hidden",
                            children: L
                        })
                    }),
                    a && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsx"])("iframe", {
                        ref: t,
                        className: x,
                        title: c,
                        width: "560",
...
const ne = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["forwardRef"](ee);
;
 //# sourceMappingURL=index.es.js.map
}),
"[project]/node_modules/@justinribeiro/lite-youtube/lite-youtube.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
customElements.define('lite-youtube', LiteYTEmbed); //# sourceMappingURL=lite-youtube.js.map
}),
]);

//# sourceMappingURL=node_modules_9d48a92e._.js.map